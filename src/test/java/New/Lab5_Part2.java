...
public class Lab5_Part2 {
	...
	public static void main(String[] args) {
        ...
        firstName.sendKeys("tejjhggydyhhjrjbhuhuhnjnjjjuhhgb");
        firstName.clear();
		...
		lastName.sendKeys("Tejaswani");
		
		WebElement email = driver.findElement(By.id("input-email"));
		email.sendKeys("oletitejaswani2003@gmail.com");
		
		WebElement PhoneNumber = driver.findElement(By.id("input-telephone"));
		PhoneNumber.sendKeys("9098979695");
